...
class ThreadsClient:
    """Synchronous client for Meta's Threads API."""
    ...
    def _wait_for_container(self, container_id: str, timeout: int = 60) -> ContainerStatus:
    ...
    def _create_and_publish(
        ...
        response = self._request("POST", f"/{user_id}/threads", data=payload)
    ...
    def create_image_post(self, image_url: str, text: str = "") -> ThreadsPost:
    ...
    def create_video_post(self, video_url: str, text: str = "") -> ThreadsPost:
    ...
    def reply_to_post(self, post_id: str, text: str) -> ThreadsPost:
    ...
    def get_user_posts(self, limit: int = 25) -> list[ThreadsPost]:
    ...
    def get_post_replies(self, post_id: str) -> list[PostReply]:
        ...
        response = self._request("GET", f"/{post_id}/replies")
        data = response.json().get("data", [])
    ...
    def get_user_profile(self, user_id: Optional[str] = None) -> UserProfile:
        ...
        response = self._request("GET", f"/{uid}")
